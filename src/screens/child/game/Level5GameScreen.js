...
const cardData = [
  ...
  { id: 15, framework: "unicorn", frontImage: require("../../../assets/icons/unicorn.png") },
  { id: 16, framework: "unicorn", frontImage: require("../../../assets/icons/unicorn.png") },
  { id: 17, framework: "bear", frontImage: require("../../../assets/icons/bear.png") },
  { id: 18, framework: "bear", frontImage: require("../../../assets/icons/bear.png") },
];

const Level5GameScreen = () => {
        ...
        if (username !== null) {
          ...
          try {
            fetch(GAME_SAVE_API, {
              ...
              .then((data) => {
                Alert.alert("Completed", "All Level Your Done!")
              })
              .catch((error) => {
...
export default Level5GameScreen;
