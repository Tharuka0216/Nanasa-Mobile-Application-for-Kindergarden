              ...
              .then((data) => {
                ...
                if (nextLevel === 2) {
                  ...
                  if (nextLevel === 3) {
                    ...
                    if (nextLevel === 4) {
                      Alert.alert("Completed", "Your Promoted Level 4");
                      commonNavigationLevel4();
                    } else {
                      if (nextLevel === 5) {
                        Alert.alert("Completed", "Your Promoted Level 5");
                        commonNavigationLevel5();
                      } else {
                        Alert.alert("Error", ""+nextLevel);
                      }
                    }
                  }
                }
    ...
    <View style={[Theme.container, Theme.bgWhite, Theme.w100, Theme.h100]}>
      ...
      <ImageBackground
        ...
        <View style={[Theme.w100, Theme.h93, Theme.justAlign]}>
          <View style={[Theme.w90, Theme.h7, Theme.justAlign]}>
          ...
          <View style={[Theme.h2]} />
          <View style={[Theme.w90, Theme.h60, Theme.justAlign]}>
...
export default Level1GameScreen;
